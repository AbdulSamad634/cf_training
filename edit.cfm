...
<!---
ID: #ID#
EMPLOYEEE NAME: #Employee_Name#
             --->

            <div class="form-container">

            <form action="index.cfm?Edit=1&ID=#ID#" method="POST">
               ...
               <cfloop query="EmployeeQuery">
                ...
                <select name="Gender" id="gender" class="form-select" autocomplete="off" value=#Gender# required>
              ...
              <!---  value="#DateFormat(#Joining_Date#,"yyyy-mm-dd")#" --->
                ...
                <label
                    ...
                    class="form-label"
                >
                    I confirm this data is accurate and updated to the best
                    of my knowledge.
                </label>
                </div>
