...
<!---
        ...
        <!--- <cfdump var = "#server.coldfusion.productversion#" > --->
         ...
         <div class="button1"> 
         <a href="/admin/employee/employee_form.cfm"><button class="btn btn-dark ">Add New Employee</button></a>

         </div>

         <div class="button2">

         <a href="/admin/employee/employee_display.cfm"><button class="btn btn-dark ">Display Employees</button></a>

         </div>

         <div class="button3">

         <a href="/admin/allowance/allowance_form.cfm"><button class="btn btn-dark ">Add New Allowance</button></a>
         ...
         <a href="/admin/allowance/allowance_display.cfm"><button class="btn btn-dark ">Display Allowances</button></a>

         </div>

         <div class="button3">

         <a href="/admin/employee/temp_employee_delete.cfm"><button class="btn btn-dark ">Recycle Bin</button></a>
